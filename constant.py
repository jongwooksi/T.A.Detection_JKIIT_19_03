...
def parser_args():
    ...
    parser.add_argument('-i', '--iters', type=int, default=25000,
    ...
    parser.add_argument('--train_folder', type=str, default='/home/jwsi/ext_hdd/pgan/dataset/accident/training',
                        help='set the training folder path.')
    parser.add_argument('--test_folder', type=str, default='/home/jwsi/ext_hdd/pgan/dataset/accident/testing',
...
const.MONODEPTH_CHECKPOINT = '/home/jwsi/ext_hdd/backup/jongwook/ano_pred_cvpr2018-master/Codes/checkpoints/model_kitti/model_kitti'
const.MONO_HEIGHT = 256
const.MONO_WIDTH = 512
...
const.LAM_MONO = config.getfloat(const.DATASET, 'LAM_MONO')
...
const.SAVE_DIR = '{dataset}_l_{L_NUM}_alpha_{ALPHA_NUM}_lp_{LAM_LP}_' \
                 'adv_{LAM_ADV}_gdl_{LAM_GDL}_flow_{LAM_FLOW}_mono_{LAM_MONO}'.format(dataset=const.DATASET,
                                                                      L_NUM=const.L_NUM,
                                                                      ALPHA_NUM=const.ALPHA_NUM,
                                                                      LAM_LP=const.LAM_LP, LAM_ADV=const.LAM_ADV,
                                                                      LAM_GDL=const.LAM_GDL, LAM_FLOW=const.LAM_FLOW, LAM_MONO=const.LAM_MONO)
